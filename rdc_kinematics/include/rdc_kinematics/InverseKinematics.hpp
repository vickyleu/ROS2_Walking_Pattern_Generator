#ifndef RDC_INVERSE_KINEMATICS_HPP
#define RDC_INVERSE_KINEMATICS_HPP
...
{
  class RDC_InverseKinematics : public control_plugin_base::InverseKinematics {
    public:
      RDC_InverseKinematics(){}
      ~RDC_InverseKinematics(){}
      ...
      void inverse_kinematics(
        const std::shared_ptr<control_plugin_base::LegStates_ToIK> ,
        std::array<double, 6>& 
      ) override {};
